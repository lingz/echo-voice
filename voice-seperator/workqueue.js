...
*
* @param queueRef A Firebase reference to the list of work items (ids)
* @param processingCallback The callback to be called for each work item
*/

function WorkQueue(queueRef, base64Store, processingCallback) {
  this.base64Store = base64Store;
    ...
    toProcess.transaction(function(theItem) {
      ...
      if(theItem) {
       ...
       if(committed) {
          ...
          self.processingCallback(dataToProcess, self.base64Store, function() { self.readyToProcess(); });
       } else {
